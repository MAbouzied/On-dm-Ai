...
const bulkUpdateSchema = z.record(z.string().regex(CONFIG_KEY_PATTERN, "Key must follow page.section.field pattern"), z.union([z.string(), z.array(z.record(z.unknown())), z.null()]));
