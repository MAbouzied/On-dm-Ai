...
export function BlogHero() {
  ...
  const badge = getConfigEnAr(config, "blogPage.badge", locale, t("badge"));
  const title = getConfigEnAr(config, "blogPage.title", locale, t("title"));
  const description = getConfigEnAr(config, "blogPage.description", locale, t("description"));
  const placeholder = getConfigEnAr(config, "blogPage.placeholder", locale, t("placeholder"));
  const subscribe = getConfigEnAr(config, "blogPage.subscribe", locale, t("subscribe"));
