...
export function BlogPostContent({ blocks, dir = "ltr" }: BlogPostContentProps) {
  return (
            ...
            case "paragraph":
              return (
                <SafeHtml
                  ...
                  html={block.content}
                  dir={dir}
                  className="[&>a]:text-gray-900 [&>a]:underline [&>a]:decoration-gray-400 [&>a]:underline-offset-4 hover:[&>a]:decoration-gray-900 hover:[&>a]:text-black transition-colors [&>h2]:text-2xl [&>h2]:font-bold [&>h2]:text-black [&>h2]:mt-10 [&>h2]:first:mt-0 [&>h3]:text-xl [&>h3]:font-bold [&>h3]:text-black [&>h3]:mt-6 [&>ul]:list-disc [&>ul]:list-inside [&>ul]:space-y-2 [&>ol]:list-decimal [&>ol]:list-inside [&>ol]:space-y-2 [&>img]:max-w-full [&>img]:rounded-lg"
                />
              );
            case "image":
              return (
