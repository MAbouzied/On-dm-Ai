 ...
 * Never exits with non-zero; resilient to dotenv or path errors.
 */
try {
  require("dotenv/config");
} catch (e) {
  // dotenv optional - env vars may come from Hostinger
}
...
try {
  ...
  console.warn("[startup-check] Error:", e.message || e);
}
